...
cdef extern from "fd_base58.h":
    char* fd_base58_encode_32(const unsigned char* bytes, unsigned* opt_len, char* out)
    char* fd_base58_encode_64(const unsigned char* bytes, unsigned* opt_len, char* out)
